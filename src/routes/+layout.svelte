...
<MetaTags
  {title}
  description="Tabler icon set for Svelte"
  openGraph={{
    type: 'website',
    url: 'https://svelte-tabler.vercel.app/',
    title: 'Svelte Tabler',
    description: 'Tabler icon set for Svelte',
    images: [
      {
        url: 'https://open-graph-vercel.vercel.app/api/svelte-tabler',
        width: 1200,
        height: 630,
        alt: 'Svelte Tabler'
      }
    ],
    siteName: 'Svelte Tabler'
  }}
  twitter={{
    handle: '@shinokada',
    ...
    title: 'Svelte Tabler',
    description: 'Tabler icon set for Svelte',
    image: 'https://open-graph-vercel.vercel.app/api/svelte-tabler',
    imageAlt: 'Svelte Tabler'
  }}
/>

<div class="max-h-screen overflow-auto relative w-full" id="svelte">
  <header
    class="sticky top-0 z-40 flex-none w-full mx-auto bg-white border-b border-gray-200 dark:border-gray-600 dark:bg-zinc-950"
  >
  <Navbar color="default" fluid let:hidden let:toggle class="dark:bg-zinc-950 ">
    <NavBrand href="/">
      <span
    ...
    >
      ...
      <NavLi class="lg:px-2 lg:mb-0" href="https://github.com/shinokada/svelte-tabler">GitHub</NavLi
      >
...
<Footer footerType="logo" class="dark:bg-zinc-950">
  <div class="sm:flex sm:items-center sm:justify-between">
    <FooterBrand
      href="https://svelte-tabler.vercel.app/"
      name="Svelte Tabler"
    ...
    >
      ...
      <FooterLink class="lg:px-2 lg:mb-0" href="https://github.com/shinokada/svelte-tabler"
        >GitHub</FooterLink
      >
