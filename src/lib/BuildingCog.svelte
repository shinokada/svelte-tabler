...
>
	...
	{/if}
	<path d="M3 21h9" /> <path d="M9 8h1" /> <path d="M9 12h1" /> <path d="M9 16h1" />
	<path d="M14 8h1" /> <path d="M14 12h1" />
	<path
	...
	/> <path d="M18 14.5v1.5" /> <path d="M18 20v1.5" /> <path d="M21.032 16.25l-1.299 .75" />
