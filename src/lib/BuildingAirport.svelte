...
>
  ...
  <path d="M8 2v2" /> <path d="M6 12v9h4v-9" /> <path d="M3 21h18" /> <path d="M22 5h-6l-1 -1" />
  <path d="M18 3l2 2l-2 2" /> <path d="M10 17h7a2 2 0 0 1 2 2v2" />
</svg>
...
@prop title
@prop desc
@prop ariaLabel = 'building airport'
@prop ...restProps
-->
