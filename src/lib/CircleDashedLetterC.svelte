<script lang="ts">
	...
	let {
		...
		title,
		desc,
		ariaLabel = 'circle dashed letter c',
		...restProps
	}: Props = $props();
...
>
	...
	{/if}
	<path d="M14 10a2 2 0 1 0 -4 0v4a2 2 0 1 0 4 0" /> <path d="M8.56 3.69a9 9 0 0 0 -2.92 1.95" />
...
@prop title
@prop desc
@prop ariaLabel = 'circle dashed letter c'
@prop ...restProps
-->
