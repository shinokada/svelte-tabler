...
>
	...
	{/if}
	<path d="M12 9a1 1 0 1 0 2 0a1 1 0 0 0 -2 0" /> <path d="M5 8l3 4l4.5 1l7.5 -1" />
	<path
	...
	/> <path d="M12 16l.5 -3" /> <path d="M6.5 5a.5 .5 0 1 0 0 -1a.5 .5 0 0 0 0 1z" />
</svg>
