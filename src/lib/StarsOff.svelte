<script>
  ...
  export let ariaLabel = 'stars off';
</script>
...
>
  ...
  />
  <path
    d="M9.557 5.556l1 -.146l1.086 -2.193a0.392 .392 0 0 1 .702 0l1.086 2.193l2.428 .352a0.39 .39 0 0 1 .217 .665l-1.757 1.707l.414 2.41a0.39 .39 0 0 1 -.014 .187m-4.153 -.166l-.744 .39a0.392 .392 0 0 1 -.568 -.41l.188 -1.093"
  />
  <path d="M3 3l18 18" />
</svg>
