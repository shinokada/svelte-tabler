<script lang="ts">
	...
	let {
		...
		title,
		desc,
		ariaLabel = 'circle dashed percentage',
		...restProps
	}: Props = $props();
...
>
	...
	{/if}
	<path d="M9 15l6 -6" /> <path d="M8.56 3.69a9 9 0 0 0 -2.92 1.95" />
	...
	<path d="M15.44 3.69a9 9 0 0 0 -3.44 -.69" /> <path d="M9 9.03v.015" />
...
@prop title
@prop desc
@prop ariaLabel = 'circle dashed percentage'
@prop ...restProps
-->
